...
const columns = [
  { key: "name", header: "Nome", render: (row: any) => <Link to={`/dashboard/admin-hospital/patients/${row.id}`} className="text-primary hover:underline cursor-pointer font-medium">{row.name}</Link> },
