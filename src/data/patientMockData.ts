...
export const familyMembers: FamilyMember[] = [
  {
    ...
    emergencyContact: { name: "Carlos Silva", phone: "+244 923 333 444", relationship: "Cônjuge" },
  ...
  },
  {
    ...
    bloodGroup: "O+",
    allergies: [],
    chronicConditions: ["Colesterol elevado"],
    emergencyContact: { name: "Maria Silva", phone: "+244 912 111 222", relationship: "Cônjuge" },
  ...
  },
  {
    ...
    emergencyContact: { name: "Maria Silva", phone: "+244 912 111 222", relationship: "Mãe" },
